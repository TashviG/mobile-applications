...
import static au.edu.canberra.mymap.R.id.url;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    //}
        ...
        Polygon p = map.addPolygon(new PolygonOptions().geodesic(true)
                ...
                .add(new LatLng(-35.23816055,149.0753323))
                ...
                /*.add(new LatLng(-35.241209, 149.082637))
                .add(new LatLng(-35.239359, 149.102868))
                .add(new LatLng(-35.2390426,149.080111))
                .add(new LatLng(-35.238713, 149.084173))
                .add(new LatLng(-35.238412, 149.090220))
                .add(new LatLng(-35.2383986,149.0859231))
                .add(new LatLng(-35.2381916,149.0834995))
                .add(new LatLng(-35.2381609,149.0818982))
                .add(new LatLng(-35.2381605,149.0753321))
                .add(new LatLng(-35.2379585,149.0831518))
                .add(new LatLng(-35.241209, 149.082637))*/
