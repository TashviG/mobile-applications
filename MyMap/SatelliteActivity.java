...
import static au.edu.canberra.mymap.R.id.map;

public class SatelliteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar toolbars = (Toolbar) findViewById(R.id.toolbar);
        toolbars.setOverflowIcon(getDrawable(R.drawable.uclogo));
    ...
    //}
        ...
        Polygon p = map.addPolygon(new PolygonOptions().geodesic(true)
                ...
                .add(new LatLng(-35.242049, 149.0902881))
                .add(new LatLng(-35.242487, 149.0881421))
                .add(new LatLng(-35.242505, 149.0780571))
                .add(new LatLng(-35.240998, 149.0748171))
                .add(new LatLng(-35.2381605,149.0753321))
                .add(new LatLng(-35.238036, 149.0770911))
                .add(new LatLng(-35.235687, 149.0777131))
                .add(new LatLng(-35.234075, 149.0785071))
                .add(new LatLng(-35.232673, 149.0796231))
                .add(new LatLng(-35.231095, 149.0804601))
                .add(new LatLng(-35.231428, 149.0821771))
                .add(new LatLng(-35.231726, 149.0833351))
                .add(new LatLng(-35.233689, 149.0871981))
                .add(new LatLng(-35.234233, 149.0885931))
                .add(new LatLng(-35.235466, 149.0898161))
                .add(new LatLng(-35.234881, 149.0919401))
                .add(new LatLng(-35.240261, 149.0901801))
                .add(new LatLng(-35.242049, 149.0902881))
